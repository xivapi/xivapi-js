...
describe("@xivapi/js", () => {
  ...
  const createSearch = (options = {}) => new Search(options);
  ...
  describe("search", () => {
    describe("basic search operations", () => {
      it("can find items by exact name match", async () => {
        ...
        const ironWarAxe = result.results.find((item: any) => item.fields.Name === "Iron War Axe");
  ...
  describe("sheets", () => {
    describe("listing sheets", () => {
      ...
      it("can list sheets with custom language options", async () => {
        const sheets = new Sheets({
    ...
    describe("reading sheet data", () => {
      ...
      it("can get a specific row with field filtering", async () => {
        const sheets = new Sheets();
